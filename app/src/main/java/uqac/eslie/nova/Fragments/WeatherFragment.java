...
*/
            // -------- KP TOMORROW --------
            TextView vt = this.getView().findViewById(R.id.tomorrow_KP_1922);
...
*/
    ...
    private void generateKPDataTomorrow() {
        ...
        for (int i = 3; i < numColumns; ++i) {
            ...
            for (int j = 0; j < numSubcolumns; ++j) {
                if(i%numColumns == 9)
                    values.add(new SubcolumnValue(Integer.parseInt(kp3Array.get(1)[2]), chooseColorKP(Integer.parseInt(kp3Array.get(1)[2])) ));
                else if(i%numColumns == 10)
                    values.add(new SubcolumnValue(Integer.parseInt(kp3Array.get(2)[2]), chooseColorKP(Integer.parseInt(kp3Array.get(2)[2]))));
                else
                    values.add(new SubcolumnValue(Integer.parseInt(kp3Array.get((i)%numColumns)[2]), chooseColorKP(Integer.parseInt(kp3Array.get((i)%numColumns)[2]))));
    ...
    private void generateCloudDataToday() {
        ...
        for (int i = 0; i < numColumns; ++i) {
            ...
            for (int j = 0; j < numSubcolumns; ++j) {
                ...
                values.add(new SubcolumnValue(Integer.parseInt(cloudArrayTodayAndTomorrow.get(i)[1]), chooseColorCloud(Integer.parseInt(cloudArrayTodayAndTomorrow.get(i)[1]))));
